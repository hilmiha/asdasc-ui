...
const SplitButtonDemo = () =>{
...
}`,N=[{id:"action-one",txtLabel:"Action One"},{id:"action-two",txtLabel:"Action Two"}],I=()=>{const{setSectionRef:t}=r(),n=s.useMemo(()=>k,[]),i=s.useMemo(()=>(console.log(v(`
    ...
    isDisabled={true}
    options={option}
/>`,m=[{id:"option-one",txtLabel:"Option One"},{id:"option-two",txtLabel:"Option Two"}],_=()=>{const{setSectionRef:t}=r(),n=s.useMemo(()=>S,[]),i=s.useMemo(()=>C,[]);return e.jsxs(e.Fragment,{children:[e.jsx("div",{id:"keyboard",ref:t("keyboard"),children:e.jsx("p",{className:"text-title-xl",children:"Keyboard Interactions"})}),e.jsxs("div",{style:{display:"grid",gap:"var(--space-150)"},children:[e.jsx("p",{children:"This component have several keyboard interaction for accesibility."}),e.jsx(b,{tableColumn:n,tableData:i})]})]})},X=()=>{const{setSectionList:t,setSectionRef:n,setPageOn:i}=r(),o=g();return s.useEffect(()=>{i(F),t(L)},[]),e.jsxs("div",{style:{display:"grid",gap:"var(--space-400)"},children:[e.jsxs("div",{id:"preview",ref:n("preview"),style:{display:"grid",gap:"var(--space-100)",alignItems:"center"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between"},children:[e.jsx("p",{className:"text-title-xl",children:"Split Button"}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-25)"},children:[e.jsx(f,{icon:e.jsx(u,{className:"global-icon"}),txtLabel:`to ${l.name}`,onClick:()=>{o(`${a}${l.path}`)}}),e.jsx(f,{icon:e.jsx(h,{className:"global-icon"}),txtLabel:`to ${p.name}`,onClick:()=>{o(`${a}${p.path}`)}})]})]}),e.jsx("p",{children:"Combination of button as action and dropdown menu as other action."}),e.jsx(B,{})]}),e.jsx(I,{}),e.jsx(A,{}),e.jsx(_,{}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-25)",justifyContent:"space-between",marginTop:"var(--space-500)"},children:[e.jsx(j,{iconBefore:e.jsx(u,{className:"global-icon"}),txtLabel:`${l.name}`,onClick:()=>{o(`${a}${l.path}`)}}),e.jsx(j,{iconAfter:e.jsx(h,{className:"global-icon"}),txtLabel:`${p.name}`,onClick:()=>{o(`${a}${p.path}`)}})]})]})};export{X as default};
