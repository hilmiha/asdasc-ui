...
const IconButtonDemo = () =>{
    ...
    <IconButton
        ...
        isSelected={true}
    />
</>`,_=()=>{const{setSectionRef:t}=d(),n=o.useMemo(()=>F,[]),l=o.useMemo(()=>L,[]);return e.jsxs(e.Fragment,{children:[e.jsx("div",{id:"keyboard",ref:t("keyboard"),children:e.jsx("p",{className:"text-title-xl",children:"Keyboard Interactions"})}),e.jsxs("div",{style:{display:"grid",gap:"var(--space-150)"},children:[e.jsx("p",{children:"This component have several keyboard interaction for accesibility."}),e.jsx(b,{tableColumn:n,tableData:l})]})]})},W=()=>{const{setSectionList:t,setSectionRef:n,setPageOn:l}=d(),i=h();return o.useEffect(()=>{l(g),t(v)},[]),e.jsxs("div",{style:{display:"grid",gap:"var(--space-400)"},children:[e.jsxs("div",{id:"preview",ref:n("preview"),style:{display:"grid",gap:"var(--space-100)",alignItems:"center"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between"},children:[e.jsx("p",{className:"text-title-xl",children:"Icon Button"}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-25)"},children:[e.jsx(a,{icon:e.jsx(u,{className:"global-icon"}),txtLabel:`to ${r.name}`,onClick:()=>{i(`${c}${r.path}`)}}),e.jsx(a,{icon:e.jsx(f,{className:"global-icon"}),txtLabel:`to ${p.name}`,onClick:()=>{i(`${c}${p.path}`)}})]})]}),e.jsx("p",{children:"A button with only icon that triggers an event or action."}),e.jsx(N,{})]}),e.jsx(C,{}),e.jsx(k,{}),e.jsx(_,{}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-25)",justifyContent:"space-between",marginTop:"var(--space-500)"},children:[e.jsx(j,{iconBefore:e.jsx(u,{className:"global-icon"}),txtLabel:`${r.name}`,onClick:()=>{i(`${c}${r.path}`)}}),e.jsx(j,{iconAfter:e.jsx(f,{className:"global-icon"}),txtLabel:`${p.name}`,onClick:()=>{i(`${c}${p.path}`)}})]})]})};export{W as default};
