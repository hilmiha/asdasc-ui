...
}`,w=()=>{const{setSectionRef:t}=c(),s=n.useMemo(()=>I,[]),a=n.useMemo(()=>E,[]);return e.jsxs(e.Fragment,{children:[e.jsx("div",{id:"keyboard",ref:t("keyboard"),children:e.jsx("p",{className:"text-title-xl",children:"Keyboard Interactions"})}),e.jsxs("div",{style:{display:"grid",gap:"var(--space-150)"},children:[e.jsx("p",{children:"This component have several keyboard interaction for accesibility."}),e.jsx(j,{tableColumn:s,tableData:a})]})]})},q=()=>{const{setSectionList:t,setSectionRef:s,setPageOn:a}=c(),l=b();return n.useEffect(()=>{a(C),t(F)},[]),e.jsxs("div",{style:{display:"grid",gap:"var(--space-400)"},children:[e.jsxs("div",{id:"preview",ref:s("preview"),style:{display:"grid",gap:"var(--space-100)",alignItems:"center"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between"},children:[e.jsx("p",{className:"text-title-xl",children:"Input Code"}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-25)"},children:[e.jsx(u,{icon:e.jsx(y,{className:"global-icon"}),txtLabel:`to ${r.name}`,onClick:()=>{l(`${o}${r.path}`)}}),e.jsx(u,{icon:e.jsx(f,{className:"global-icon"}),txtLabel:`to ${p.name}`,onClick:()=>{l(`${o}${p.path}`)}})]})]}),e.jsx("p",{children:"Input area for code."}),e.jsx(T,{})]}),e.jsx(N,{}),e.jsx(V,{}),e.jsx(w,{}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-25)",justifyContent:"space-between",marginTop:"var(--space-500)"},children:[e.jsx(h,{iconBefore:e.jsx(y,{className:"global-icon"}),txtLabel:`${r.name}`,onClick:()=>{l(`${o}${r.path}`)}}),e.jsx(h,{iconAfter:e.jsx(f,{className:"global-icon"}),txtLabel:`${p.name}`,onClick:()=>{l(`${o}${p.path}`)}})]})]})};export{q as default};
