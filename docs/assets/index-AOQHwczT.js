...
`}]},q=()=>{const{setSectionList:e,setSectionRef:l,setPageOn:f}=p(),n=b();return c.useEffect(()=>{f(h),e(k)},[]),t.jsxs("div",{style:{display:"grid",gap:"var(--space-400)"},children:[t.jsx("div",{className:"global-radius",style:{backgroundColor:"var(--clr-orange-100)",padding:"var(--space-100) var(--space-200)",border:"1px solid var(--clr-border-orange)"},children:t.jsx("p",{style:{textAlign:"center"},children:t.jsx("strong",{children:"Documentation is in progress 🚧"})})}),t.jsxs("div",{id:"preview",ref:l("preview"),style:{display:"grid",gap:"var(--space-100)",alignItems:"center"},children:[t.jsxs("div",{style:{display:"flex",justifyContent:"space-between"},children:[t.jsx("p",{className:"text-title-xl",children:"Wysiwyg"}),t.jsx("div",{style:{display:"flex",gap:"var(--space-25)"},children:t.jsx(u,{icon:t.jsx(i,{className:"global-icon"}),txtLabel:`to ${r.name}`,onClick:()=>{n(`${s}${r.path}`)}})})]}),t.jsx("p",{children:"Text editor"}),t.jsx(m,{})]}),t.jsx("div",{style:{display:"flex",gap:"var(--space-25)",justifyContent:"space-between",marginTop:"var(--space-500)"},children:t.jsx(d,{iconBefore:t.jsx(i,{className:"global-icon"}),txtLabel:`${r.name}`,onClick:()=>{n(`${s}${r.path}`)}})})]})};export{q as default};
