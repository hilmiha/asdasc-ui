...
import { AppTemplateContext, type AppTemplateContextValue } from './context'
...
const AppTemplate = ({
    ...
    const ctxValue: AppTemplateContextValue = {
        isShowTopnav, 
        setIsShowTopnav
    };
    ...
    return(
        <AppTemplateContext.Provider value={ctxValue}>
            <div className={clsx("app-template", screenSize)}>
                <div className='top-banner-box'>
                </div>
                <div className={`top-nav-box ${isShowTopnav?('show-top-nav'):('hide-top-nav')}`}>
