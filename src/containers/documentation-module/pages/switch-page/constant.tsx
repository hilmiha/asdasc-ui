...
export const sections = [
    {id:'preview', txtLabel:'Switch', isSub:false},
    {id:'api_ref', txtLabel:'API Refrence', isSub:false},
    {id:'api_ref_1', txtLabel:'Switch', isSub:true},
    {id:'api_ref_2', txtLabel:'SwitchButton', isSub:true},
    {id:'example', txtLabel:'Example', isSub:false},
    {id:'example_1', txtLabel:'Switch as an indicator only', isSub:true},
    {id:'example_2', txtLabel:'Controlled group of Switchs', isSub:true},
