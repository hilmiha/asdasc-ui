        ...
        >
            ...
            >
                <div style={{
                    ...
                    <p className="text-title-xl">Dropdown Menu</p>
                ...
                <p>
                    Extension of <span className="text-code">Dropdown</span> specifically for showing menu items. It also provide menu items in <span className="text-code">BottomSheet</span> on mobile view. 
                </p>
                <PreviewSection/>
            </div>
            <ApiReferenceSection/>
