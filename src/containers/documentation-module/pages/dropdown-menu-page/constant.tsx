...
export const pageId = 'dropdown-menu';
...
export const apiRefTableColumnList:tableColumnType[] = [
    {key:'prop', txtLabel:'Prop', size:{min:'195px', size:'0.5fr'}},
    {key:'type', txtLabel:'Type', size:{min:'220px', size:'1fr'}},
    {key:'default', txtLabel:'Default', size:{min:'100px', size:'0.3fr'}},
]

export const apiRefDropdownMenuList:tableRowDataType[] = [
    {
        "id": "1",
    ...
    },
    {
        ...
        "type": <p style={{fontFamily:'monospace'}}>dropdownMenuStyleType</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    },
    {
        "id": "4",
    ...
    {
        "id": "7",
        "prop": <p style={{fontFamily:'monospace'}}>optionSelectedAppearance</p>,
    ...
    },
    {
        ...
        "type": <p style={{fontFamily:'monospace'}}>{`function (idOption, option, event) => void`}</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    },
    {
        "id": "10",
