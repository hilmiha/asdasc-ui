...
const PreviewSection = () =>{
    const content = useMemo<Delta | undefined>(()=>{
        return sampleDelta as Delta
    },[]);
    ...
    return(
        ...
        >
            <PreviewBox>
                <p style={{textAlign:'center', marginBottom:'var(--space-100)'}}>Classic Looks</p>
                <Wysiwyg type="classic" value={content}/>
            </PreviewBox>
            <PreviewBox>
                <p style={{textAlign:'center', marginBottom:'var(--space-100)'}}>With Floating Toolbar (select text to show toolbar)</p>
                <Wysiwyg type="floating" value={content}/>
            </PreviewBox>
            <InputCode
                lang="tsx"
                isDisabled={true}
