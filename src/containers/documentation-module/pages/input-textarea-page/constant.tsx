...
export const pageId = 'input-textarea';
...
export const sections = [
    {id:'preview', txtLabel:'Input Textarea', isSub:false},
    {id:'api_ref', txtLabel:'API Refrence', isSub:false},
    {id:'api_ref_1', txtLabel:'InputTextarea', isSub:true},
    {id:'example', txtLabel:'Example', isSub:false},
    {id:'example_0', txtLabel:'Disabled field', isSub:true},
    {id:'example_01', txtLabel:'Set init and max line text area', isSub:true},
...
export const apiRefInputTextareaList:tableRowDataType[] = [
    {
        "id": "1",
        "prop": <p style={{fontFamily:'monospace'}}>ref</p>,
        "type": <p style={{fontFamily:'monospace'}}>{`React.Ref<HTMLTextAreaElement>`}</p>,
    ...
    },
    {
        ...
        "type": <p style={{fontFamily:'monospace'}}>inputTextareaStyleType</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    },
    {
        "id": "5",
    ...
    },
    {
        ...
        "type": <p style={{fontFamily:'monospace'}}>inputTextareaType</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    },
    {
        "id": "9",
    ...
    },
    {
        ...
        "type": <p style={{fontFamily:'monospace'}}>{`(newValue, event) => void`}</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    },
    {
        "id": "13",
    ...
    },
    {
        ...
        "type": <p style={{fontFamily:'monospace'}}>{`(error, value) => void`}</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    },
    {
        "id": "17",
        "prop": <p style={{fontFamily:'monospace'}}>config</p>,
        "type": <p style={{fontFamily:'monospace'}}>inputTextareaConfigType</p>,
        "default": <p style={{fontFamily:'monospace'}}>undefined</p>
    }
]